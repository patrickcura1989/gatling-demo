...
class BasicSimulation extends Simulation {
  ...
  val validDataWriter = {
    val fos = new java.io.FileOutputStream("validData.csv")
    new java.io.PrintWriter(fos,true)
  }

  val urlresponse: HttpResponse[String] =
    Http("https://api.nasdaq.com/api/calendar/dividends?date=2021-06-14")
      ...
      .asString
  val jsonAst = urlresponse.body.parseJson // or JsonParser(source)
